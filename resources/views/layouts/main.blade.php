...
<head>
    ...
    <title>Guido Halley Portfolio </title>
                ...
                <div
                    ...
                    <div class="pt-[100px] pb-8">
                        ...
                        <div class="flex justify-center space-x-3">
                            ...
                            <!-- instagramicon and link -->
                            <a href="{{$user_public->instagram_url}}" target="_blank" rel="noopener noreferrer">
                                <span class="socialbtn text-[#1C9CEA]">
                                    <i class="fa-brands fa-instagram"></i>
                                </span>
                            </a>                           
                            <!-- linkedin icon and link -->
                            <a href="{{$user_public->linkeid_url}}" target="_blank" rel="noopener noreferrer">
                        ...
                        <div class="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
                            ...
                            <div class="flex py-2.5">
                                ...
                                <div class="text-left ml-2.5">
                                    ...
                                    <p class="dark:text-white">{{ Carbon\carbon::parse($user_public->birthday)->format('d-m-Y') }}</p>
                                </div>
                            </div>
                        </div>
                        <!-- personal infomation end-->
                        <!-- dowanload button -->
                        {{-- <a href="" download><button class="dowanload-btn">
                            <img class="mr-3" src="{{asset('public\images\cv\CV.pdf')}}" alt="icon" /> Descargar CV </button></a> --}}
                    </div>
                </div>
            </div>
