            ...
            <div class="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
                ...
                <div class="lg:hidden">
                    <div
                        ...
                        <div class="pt-[100px] pb-8">
                            <h2 class="mt-6 mb-1 text-[26px] font-semibold dark:text-white"> Guido Halley</h2>
                            <h3
                ...
                <div class="lg:grid grid-cols-12 md:gap-10 pt-4 md:pt-[30px] items-center hidden">
                    <div class="col-span-12 space-y-2.5">
                        <div class="lg:mr-16">
                            <p class="text-[#44566c] dark:text-color-910 leading-7"> 📝 Estudiante de Analista de Sistemas en 3 Año. </p>
                            <p class="text-[#44566c] dark:text-color-910 leading-7"> 🌐 Trabajando como Desarrollador Web en el Poder Judicial de Misiones </p>
                            <p class="text-[#44566c] dark:text-color-910 leading-7"> ⌨️CO-FUNDADOR DE <a href="http://twodesigners.online">twodesigners.online</a> 
                            </p>
                        </div>
                        <div></div>
                    </div>
                ...
                <div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
                    <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                        <img class="w-10 h-10 object-contain block" src="{{asset('images/icons/icon.svg')}}"
                            alt="icon" />
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold"> MicroServicios Web </h3>
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Conecto Aplicaciones web entre si para intercambiar informacion. </p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#fefaf0] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Creo Paginas Web, o tambien sistemas digitales, recuerda que 
                                Si no tienes aplicación hoy en día no eres nadie. </p>
                        </div>
                    </div>
                    <div class="about-box bg-[#fff0f8] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Cada vez que alguien necesita alguna ayuda informatica puedo otorgarla. </p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#f3faff] dark:bg-transparent">
                        <img class="w-10 h-10 object-contain block" src="{{asset('images/icons/icon5.svg')}}"
                            alt="icon" />
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold"> Seo Web </h3>
            ...
            <footer class="overflow-hidden rounded-b-2xl" style="background: transparent">
                <p class="text-center py-6 text-gray-lite dark:text-color-910"> © 2023 Todos los derechos reservados
                    by <a class="hover:text-[#FA5252] duration-300 transition"
                        href="https://github.com/guidohalley/guidohalley" target="_blank"
                        rel="noopener noreferrer"> Guido Halley</a>. </p>
            </footer>
            <!-- footer section end -->
        </div>
    </div>
